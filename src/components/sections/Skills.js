      ...
      subSections: [
        {
          ...
          icon: "fa fa-code",
          skills: [
            { name: "Javascript / Typescript / HTML & CSS", percentage: "95%" },
            { name: "React / Vue / Angular", percentage: "95%" },
            { name: "Redux / Pinia", percentage: "90%" },
            { name: "NodeJs / Java / PHP", percentage: "75%" },
    ...
    },
    {
      ...
      subSections: [
        ...
        },
        {
          ...
          icon: "fa fa-flag",
          skills: [
              { name: "Node.js, Java & PHP backend development" },
              { name: "Scalable REST & GraphQL API design" },
              { name: "Database schema design, migrations & indexing (SQL & NoSQL)" },
              { name: "Containerization & orchestration (Docker, Kubernetes)" },
              { name: "Authentication & authorization (OAuth2, JWT, SSO)" },
              { name: "UI/UX collaboration & accessibility best practices" },
              ...
              { name: "Website hosting & deployment across environments" },
          ],
        },
      ],
    },
